...
export default class EyeOfThePassword extends React.Component {
	constructor () {
		super ();
		this.state = {
	...
	componentDidMount(): void {
		if (!this.props.onChangeText) {
			console.warn('EyeOfThePassword: onChangeText() method is necessary');
		}
	}

	toggleVisibility = () => {
		this.props.toggleSecureEntry();
	...
	render () {
		return (
			<View style={{flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center'}}>
				...
				/>
				{!this.state.showingPassword && <TouchableOpacity onPress={this.toggleVisibility.bind(this)}><Image
					source={require('../../../../../assets/images/eye-solid.png')}
					style={{width: 25, height: 20, tintColor: theme.primary}}/></TouchableOpacity>}
				{this.state.showingPassword && <TouchableOpacity onPress={this.toggleVisibility.bind(this)}><Image
					source={require('../../../../../assets/images/eye-slash-solid.png')}
					style={{width: 25, height: 20, tintColor: theme.primary}}/></TouchableOpacity>}
			</View>
		);
	}
