            ...
            <View style={styles.container}>
                {
                	this.props.item.field === 'textArea' &&
	                    <View style = {{ alignSelf:'center', marginBottom: theme.height * 0.01, marginTop: theme.height * 0.04, justifyContent: 'center', width: theme.width * 0.9 }}>
	                        <Text style = {{fontWeight:'bold' ,fontSize:22, marginBottom:theme.height * 0.01, textAlign: 'auto'}}>{this.props.item.label}</Text>
	                        <TextInput
